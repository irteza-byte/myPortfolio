...
export default function PortfolioCardPokelog() {
    return (
        <div className="group w-full max-w-sm transition-all duration-700 transform hover:scale-[1.02] mx-auto">
                ...
                <div className="rounded-2xl bg-gray-900 relative overflow-hidden shadow-xl shadow-gray-950/50">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="p-4 text-center">
                            <h3 className="text-lg font-manrope font-semibold text-gray-100 transition-all duration-500 group-hover:text-blue-400">
                                Pokedex
                            </h3>
                            <p className="text-gray-400 text-sm mt-1">
                                Displays real-time Pokémon data via the Pokédex API.
                            </p>
                            ...
                            <div className="mt-4 flex flex-col sm:flex-row justify-center gap-3">
                                {/* Live Demo Button */}
                                <a
                                    href="https://pokedex-theta-mocha.vercel.app/"
                                ...
                                {/* View Code Button */}
                                <a
                                    href="https://github.com/irteza-byte/pokelog"
